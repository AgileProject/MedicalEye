...
public class GetMongoDBData {
    ...
    public void getMongoDBData()
    {
        ...
        IComputerDao computerDao = (IComputerDao)DaoFactory.getInstance("Computer","jsontest","10.6.12.47");
        ...
        if (getSQLServerRec.getHardRec()!=0) {
            IHardwareDao hardwareDao = (IHardwareDao) DaoFactory.getInstance("Hardware", "jsontest", "10.6.12.47");
            hardwareDao.setLastQueryTime(getSQLServerRec.getHardDate());
        }
        if (getSQLServerRec.getDbRec()!=0) {
            IDatabaseDao databaseDao = (IDatabaseDao) DaoFactory.getInstance("Database", "jsontest", "10.6.12.47");
