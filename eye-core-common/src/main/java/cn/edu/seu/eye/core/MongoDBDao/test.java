...
//
//        for (int i = 0;i<20;i++){
//            System.out.println("get "+databaseDao.storeNRecordToListAfter(10,list)+" records");
//            for (Database database:list){
//                System.out.println(database);
//            }
//        }
...
//        IComputerDao computerDao = (IComputerDao) DaoFactory.getInstance("Computer","filetest","ee-lab",27017);
//        Computer computer = new Computer();
//        computer.setComputerOS("Linux");
//        computer.setProInfo("core5");
//        computer.setMemInfo("18g");
//        computer.setDiskInfo("wd");
//        computer.setDbInfo("mongodb");
//        computer.setTime(new Date());
//        for (int i=0;i<100;i++){
//            computer.setComputerName("Thread:"+i+"Computer");
//            computer.setComputerIP("192.168.1."+i);
...
//
//            new Timer().schedule(new TimerTask() {
//                IDao hardwaredao = DaoFactory.getInstance("Hardware", "filetest", "ee-lab", 27017);
//                Hardware hardware = new Hardware();
//                float runtime = 0;
//
//                int i = test.i;
...
//                public void run() {
//
//                    hardware.setComputerName("Thread:"+i+"Computer");
//                    hardware.setTime(new Date());
//                    hardware.setCpuUtilization((float) (Math.random() * 100));
//                    hardware.setCpuRunTime(runtime);
//                    hardware.setProcess((int) (Math.random() * 100));
//                    hardware.setMemUsedPercent((float) (Math.random() * 100));
//                    hardware.setDiskUtilization((float) (Math.random() * 100));
//                    runtime += 0.1;
//
...
//
//            new Timer().schedule(new TimerTask() {
//                IDao databasedao = DaoFactory.getInstance("Database","filetest","ee-lab",27017);
//                Database database = new Database();
//                int size = 0;
//
//                int i = test.i;
...
//                @Override
//                public void run() {
//                    database.setComputerName("Thread:"+i+"Computer");
//                    database.setDbInfo("sqlserver");
//                    database.setTime(new Date());
//                    database.setLinkNumb((int) (Math.random()*100));
//                    database.setSize(size);
//                    database.setRamUtilization((float) (Math.random()*100));
...
//        }
          ...
          IComputerDao computerDao = (IComputerDao) DaoFactory.getInstance("Computer","filetest","ee-lab",27017);
          List<Computer> list = computerDao.getAllComputers();
